...
namespace ml
{
     ...
     * These are set and cleared by the framework — read them, but be careful
     * about writing them manually:
     *
     * | Flag | Set by | Meaning |
     * |------|--------|---------|
     * | @c HOVERED   | @c UIManager | Mouse is currently over this component |
     * | @c CLICKED   | @c UIManager | Mouse button is currently held down over this component |
     * | @c FOCUSED   | @c UIManager | Component has keyboard focus |
     * | @c DRAGGING  | @c Draggable | A drag gesture is currently in progress |
     *
    ...
    enum class Flag
    {
        HOVERED,    ///< Mouse is currently over this component (set by UIManager).
        CLICKED,    ///< Mouse button is held down over this component (set by UIManager).
        HIDDEN,     ///< Component should not be drawn.
        BLINKING,   ///< Component is in a blink animation cycle.
        FOCUSED,    ///< Component has keyboard focus (set by UIManager).
        ENABLED,    ///< Component is active and interactive.
        DRAGGABLE,  ///< Enables drag handling in ComponentCore.
        DRAGGING,   ///< A drag gesture is currently in progress (set by Draggable).
