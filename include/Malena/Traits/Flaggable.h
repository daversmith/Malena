...
namespace ml
{
     ...
     * Framework code checks @c ml::Flag values to gate built-in behavior:
     *
     * | Flag | Effect |
     * |------|--------|
     * | @c ml::Flag::DRAGGABLE | Enables drag handling in @c ComponentCore |
     * | @c ml::Flag::HOVERED   | Set by @c UIManager while the mouse is over the component |
     * | @c ml::Flag::FOCUSED   | Set by @c UIManager when the component has keyboard focus |
     *
     * ### Usage
     * @code
